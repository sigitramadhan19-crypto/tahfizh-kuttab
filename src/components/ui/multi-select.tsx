...
export function MultiSelect({ options, selected, onChange, placeholder = "Pilih opsi..." }: MultiSelectProps) {
  ...
  return (
    <Command onKeyDown={handleKeyDown} className="overflow-visible bg-transparent">
      <div
        className="group border border-input px-3 py-2 text-sm ring-offset-background rounded-md focus-within:ring-1 focus-within:ring-ring focus-within:ring-offset-0 bg-white"
      >
